...
import { useInfoComment } from "../../hooks/useInfoComment";
import InfoCommentItem from "./InfoCommentItem";
import "../FreeBoard/FreeComment.css";
import api from "../../api/axiosConfig";

export default function InfoCommentSection({ boardId, currentUsername }) {
  const {
    comments,
    commentCount,
    commentPage,
      ...
      const initializeComments = async () => {
        try {
          const countRes = await api.get(
            `/api/infoboard/${boardId}/comments/count/toplevel`
          );
