  ...
  const loadProducts = async () => {
    try {
      ...
      const url = searchName.trim()
        ? `/api/products/category/COOLER/search?name=${searchName}&page=${currentPage}&size=${pageSize}&sortBy=id`
        : `/api/products/category/COOLER?page=${currentPage}&size=${pageSize}&sortBy=id`;
    ...
    <div>
      <div className="page-container">
        ...
        <div className="product-list">
          <div className="category-title">쿨러</div>
            ...
            products.map((p) => (
              <div key={p.id} className="product-card">
                ...
                <div className="product-price-container">
                  ...
                  <button onClick={() => addToCart(p.id, "COOLER")}>
                    담기
                  </button>
                </div>
              </div>
