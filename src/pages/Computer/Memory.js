  ...
  const loadProducts = async () => {
    try {
      ...
      const url = searchName.trim()
        ? `/api/products/category/MEMORY/search?name=${searchName}&page=${currentPage}&size=${pageSize}&sortBy=id`
        : `/api/products/category/MEMORY?page=${currentPage}&size=${pageSize}&sortBy=id`;
    ...
    <div>
      <div className="page-container">
        ...
        <div className="product-list">
          <div className="category-title">메모리</div>
