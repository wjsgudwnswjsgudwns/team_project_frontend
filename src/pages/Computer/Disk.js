  ...
  const loadProducts = async () => {
    try {
      ...
      const url = searchName.trim()
        ? `/api/products/category/STORAGE/search?name=${searchName}&page=${currentPage}&size=${pageSize}&sortBy=id`
        : `/api/products/category/STORAGE?page=${currentPage}&size=${pageSize}&sortBy=id`;
    ...
    <div>
      <div className="page-container">
        ...
        <div className="product-list">
          <div className="category-title">디스크(SSD/HDD)</div>
            ...
            products.map((p) => (
              <div key={p.id} className="product-card">
                ...
                <div className="product-price-container">
                  ...
                  <button onClick={() => addToCart(p.id, "STORAGE")}>
                    담기
                  </button>
                </div>
              </div>
