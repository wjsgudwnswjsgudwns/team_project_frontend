  ...
  const loadProducts = async () => {
    try {
      ...
      const url = searchName.trim()
        ? `/api/products/category/GPU/search?name=${searchName}&page=${currentPage}&size=${pageSize}&sortBy=id`
        : `/api/products/category/GPU?page=${currentPage}&size=${pageSize}&sortBy=id`;
    ...
    <div>
      <div className="page-container">
        ...
        <div className="product-list">
          <div className="category-title">그래픽카드</div>
            ...
            products.map((p) => (
              <div key={p.id} className="product-card">
                ...
                <div className="product-price-container">
                  ...
                  <button onClick={() => addToCart(p.id, "GPU")}>담기</button>
                </div>
              </div>
            ))
          )}
